...
# --- HARDCODED TREND PARAMETERS ---
# Adjust these based on the exact start and end prices of your full log.
ROOT_START_PRICE = 13000.0
ROOT_SLOPE = 0.001  # e.g., +100 price over 100,000 timestamps
